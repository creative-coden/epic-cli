...
const koaFiles = [
  ...
  { directory: 'server/controller/upload.controller.mjs', file: uploadController() },
  { directory: 'server/routes/index.mjs', file: createRoutes() },
  { directory: 'server/services/customer.service.mjs', file: createServices() },
  { directory: 'server/services/upload.service.mjs', file: uploadService() },
  { directory: 'server/middleware/cacheHandler.mjs', file: createMiddleware() },
  { directory: 'server/libs/logger.mjs', file: createLogger() },
